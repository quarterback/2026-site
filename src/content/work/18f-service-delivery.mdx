...
hero:
  image: "/images/work/service-delivery-at-scale/hero.png"
  layout: "contained"
links:
  - label: "18F Portfolio"
...
:::insights{insights='[{"icon":"exclamation-triangle","text":"Dead-end moments caused 60% of service abandonment"},{"icon":"sync","text":"Rework from unclear requirements cost 40% more staff time"},{"icon":"comment-slash","text":"Policy language didn\u0027t match how people understood eligibility"},{"icon":"network-wired","text":"Legacy systems had inconsistent integration points"}]'}
:::
...
:::image src="/images/work/service-delivery-at-scale/consequence-map.png" layout="full-bleed" caption="Consequence mapping workshop output showing how small design decisions create downstream operational impact"
:::
...
:::image-before-after before="/images/work/service-delivery-at-scale/intake-before.png" after="/images/work/service-delivery-at-scale/intake-after.png" beforeLabel="Original" afterLabel="Pattern Applied" caption="Intake flow redesign showing how surfacing requirements earlier prevents late-stage abandonment"
:::
...
:::image src="/images/work/service-delivery-at-scale/pattern-library.png" layout="inline" caption="Pattern library showing reusable components for intake, verification, and recovery flows"
:::
