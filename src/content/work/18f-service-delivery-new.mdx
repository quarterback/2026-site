...
- **Governance patterns that travel**: Building reusable decision frameworks adopted across agencies—not one-off fixes, but architectural primitives for how eligibility and case management systems should be structured
- **Operating under constraints**: Finding leverage in politically complex, policy-constrained environments where the challenge is making existing systems governable rather than building from scratch
